...
- Минимальный production-набор:
    - `maxEntries` (например 32, вынести в константу)
...
- Очистка:
    - периодический sweep (например раз в 5–10s, вынести в константу)
    - и/или при `get/set`
...
### 8.1 Ownership модель
**Вариант (максимум скорости):** кэш хранит GPU, при attach просто реиспользуем
