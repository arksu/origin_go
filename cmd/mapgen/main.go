...
func main() {
	...
	logger.Info("starting map generation",
		...
		zap.Float64("river_shape_long_meander_scale", opts.River.ShapeLongMeanderScale),
		zap.Float64("river_shape_short_meander_scale", opts.River.ShapeShortMeanderScale),
		zap.Float64("river_shape_short_meander_bias", opts.River.ShapeShortMeanderBias),
		zap.Float64("river_shape_amplitude_scale", opts.River.ShapeAmplitudeScale),
		zap.Float64("river_shape_frequency_scale", opts.River.ShapeFrequencyScale),
		zap.Float64("river_shape_noise_scale", opts.River.ShapeNoiseScale),
		zap.Float64("river_shape_along_scale", opts.River.ShapeAlongScale),
		zap.Float64("river_shape_distance_cap", opts.River.ShapeDistanceCap),
		zap.Int("river_shape_segment_length", opts.River.ShapeSegmentLength),
		...
		zap.Bool("biome_hnh_enabled", opts.Biome.HNHEnabled),
		zap.Int("biome_region_count", opts.Biome.RegionCount),
		zap.Int("biome_region_jitter", opts.Biome.RegionJitter),
		zap.Int("biome_blend_width", opts.Biome.BlendWidth),
		zap.Int("biome_smoothing_passes", opts.Biome.SmoothingPasses),
		zap.Int("biome_min_patch_tiles", opts.Biome.MinPatchTiles),
		zap.Float64("biome_forest_share", opts.Biome.ForestShare),
		zap.Float64("biome_grassland_share", opts.Biome.GrasslandShare),
		zap.Float64("biome_wetland_share", opts.Biome.WetlandShare),
		zap.Float64("biome_heath_moor_share", opts.Biome.HeathMoorShare),
		zap.Float64("biome_mountain_share", opts.Biome.MountainShare),
		zap.Bool("ecology_enabled", opts.Ecology.Enabled),
		zap.Int("ecology_tick_interval", opts.Ecology.TickInterval),
		zap.Int("ecology_cells_per_tick", opts.Ecology.CellsPerTick),
		zap.Int("ecology_chunk_budget", opts.Ecology.ChunkBudget),
		zap.Float64("ecology_spread_scale", opts.Ecology.SpreadScale),
